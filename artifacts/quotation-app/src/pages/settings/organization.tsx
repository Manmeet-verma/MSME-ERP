  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto">
      ...
      <div className="bg-card border border-card-border rounded-xl p-6">
        <form onSubmit={(e) => { e.preventDefault(); if (canEdit) update.mutate({ data: { name: form.name, gstNumber: form.gstNumber || undefined, phone: form.phone || undefined, address: form.address || undefined } }); }} className="space-y-4">
